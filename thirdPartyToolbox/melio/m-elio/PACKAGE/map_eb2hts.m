function [data_hts] = map_eb2hts(eb_h,eb_data)
%function [data_hts] = map_eb2hts(eb_h, data_eb)
% map a vector of data as extracted from elcirc binary files dat(kbp:nvrt,1:np)
% to array as required by hotstart files dat(1:np,1:nvrt). including filling in of the values above and below kfp kbp with nan
%
