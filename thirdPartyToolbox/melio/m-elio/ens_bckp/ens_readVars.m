...
d.e = d.e(ens_cidx(stateInfo.maskRead.e));
...
d.s = d.s(ens_cidx(stateInfo.maskRead.s));
...
d.t = d.t(ens_cidx(stateInfo.maskRead.t));
...
d.u = duv(ens_cidx(stateInfo.maskRead.uv),1);
d.v = duv(ens_cidx(stateInfo.maskRead.uv),2);
