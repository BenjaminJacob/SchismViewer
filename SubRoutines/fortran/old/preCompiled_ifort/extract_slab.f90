...
! 	Changed by Benjamin Jacob to read settings (fill_in,basedir,binary_file,istack1,istack2,bp_file	
!       via function new function get_opts instead of hard coding
...
!      endif
      ...
      call get_opts_slab(fill_in,basedir,binary_file,istack1,istack2,ialong_S,klev0,ifs,zout)	
