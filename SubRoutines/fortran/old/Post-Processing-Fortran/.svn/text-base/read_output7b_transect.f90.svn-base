...
!       ifort -Bstatic -assume byterecl -O3 -o read_output7b_transect read_output7b_transect.f90 moving_average_filter.f90 ../../UtilLib/compute_zcor.f90 ../../UtilLib/pt_in_poly.f90
!       pgf90 -O2 -mcmodel=medium -Mbounds -Bstatic -o read_output7b_transect read_output7b_transect.f90 moving_average_filter.f90 ../../UtilLib/compute_zcor.f90 ../../UtilLib/pt_in_poly.f90
!											*
!****************************************************************************************
!
      program read_out
...
!     Horizontal grid
     ...
     &out2(nxy,nvrt,2),icum(np,nvrt,2),eta2(np),node3(nxy,3),arco(nxy,3),iep(nxy), &
