...
!       pgf90 -O2 -mcmodel=medium -Mbounds -Bstatic -o compute_alongchannel_vel compute_alongchannel_vel.f90 ~/SELFE/svn/trunk/src/Utility/UtilLib/compute_zcor.f90 ~/SELFE/svn/trunk/src/Utility/UtilLib/pt_in_poly.f90
