...
!											*
!       pgf90 -O2 -mcmodel=medium -Mbounds -Bstatic -o read_output7b_xyzt read_output7b_xyzt.f90 ~/SELFE/svn/trunk/src/Utility/UtilLib/compute_zcor.f90 ~/SELFE/svn/trunk/src/Utility/UtilLib/pt_in_poly.f90


!pgf90 -O2 -mcmodel=medium -Mbounds -Bstatic -o read_output7b_xyzt read_output7b_xyzt.f90 UtilLib/compute_zcor.f90 /UtilLib/pt_in_poly.f90



! ifort -assume byterecl -O2 -Bstatic -o read_output7b_xyzt read_output7b_xyzt.f90 UtilLib/compute_zcor.f90 UtilLib/pt_in_poly.f90
!****************************************************************************************
!
      program read_out
      parameter(nbyte=4)
